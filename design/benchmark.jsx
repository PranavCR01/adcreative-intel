/* Benchmark page (route: #/benchmark) */
      ...
      <div className="bench-section">
        ...
        <div className="chart">
          <div className="chart-legend">
            ...
            <div className="it" style={{ marginLeft: "auto" }}><span className="sw" style={{ background: "var(--text-2)", border: "1px dashed var(--text-2)", background: "transparent" }}></span> val · total</div>
          </div>
          <LossChart />
...
function LossChart() {
  // 30 epochs of fake-but-plausible training curves
  const epochs = 30;
  const data = [];
  ...
  const X = (i) => padL + (i / (epochs - 1)) * (w - padL - padR);
